...
export default function MobileAppSection(){
    return (
        <div className="card-sign-up-section mobileAppSection">
            <div className="content">
                ...
                <p className={`para ${satoshiLight.className}`}>Download Art Vault app for IOS & Android to fill your in everything about the Art&apos;s World.</p>

                <div className="buttons-mobileAppSection">
