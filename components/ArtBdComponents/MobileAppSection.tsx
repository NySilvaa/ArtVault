...
export default function MobileAppSection(){
    return (
        <div className={`${styles.card_signUp_section} card_signUp_section mobileAppSection`}>
            <div className={styles.contentSection}>
                ...
                className="lucide lucide-bell-icon lucide-bell"><path d="M10.268 21a2 2 0 0 0 3.464 0"/><path d="M3.262 15.326A1 1 0 0 0 4 17h16a1 1 0 0 0 .74-1.673C19.41 13.956 18 12.499 18 8A6 6 0 0 0 6 8c0 4.499-1.411 5.956-2.738 7.326"/></svg>

                <h3 className={leotaroFree.className}>Download Our Mobile App</h3>
                <p className={`${styles.para} ${satoshiLight.className}`}>Download Art Vault app for IOS & Android to fill your in everything about the Art&apos;s World.</p>

                <div className={styles.buttons_mobileAppSection}>
                    <Link href="#" className={styles.button_maChildren}>
                    ...
                    <Link href="#" className={styles.button_maChildren}>
                        <span className={styles.icon}><svg width="34" height="34" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
